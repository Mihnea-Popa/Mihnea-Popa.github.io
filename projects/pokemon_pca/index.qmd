...
To run the full pipeline in one place, I aggregated every `.py` into a single Jupyter notebook. Download it here: <a href="pokemon_pca_notebook.ipynb" target="_blank">pokemon_pca_notebook.ipynb</a>. The only requirements are `pandas`, `scikit-learn` and `plotly`.
