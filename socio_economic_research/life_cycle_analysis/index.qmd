...
subtitle: "ENSAE Paris — Environmental Issues (OMI448)"
author: "Mihnea Popa"
order: 1
date: "April 2024"
format:
...
4. **Excluded impact categories:** the study does not cover eutrophication (relevant for mining), land use, water depletion, or toxicity from mining. The lithium-ion supply chain (particularly cobalt from the DRC and lithium from Andean salt flats) raises serious concerns in these excluded categories.
5. **No dynamic LCA:** a temporally dynamic LCA would account for the grid decarbonising *during* the vehicle's operating life, which would make the EV comparison progressively more favourable year by year.
