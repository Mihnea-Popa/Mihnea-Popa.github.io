...
The full derivations, architecture specifications, and extended robustness tables are in the [report](GNN_Portfolio_Report_v3.pdf); the [slides](GNN_Portfolio_Presentation.pdf) walk through the three-stage design and key results in presentation form.
