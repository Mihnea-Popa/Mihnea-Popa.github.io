---
title: "Adaptive Optimal Execution for a $10M AAPL Buy Order — AI-Assisted Development"
author: Mihnea POPA
description: " "
date: June 2026
order: -2
...
Before committing to V1's signal set, I (with Claude) ran an empirical accuracy comparison of L1 vs. L2 directional signals on the training date, at both 1-minute and 5-minute horizons:
...
L2 signals were *worse than random* at the 5-minute checkpoint horizon for AAPL — the instructor's read is that "HFT market-maker quoting dominates levels 1-9," so depth beyond the top of book is mostly noise for a 5-minute decision cadence. That result is why both V1 and V2 stayed L1-only by design, in contrast to the L2-heavy trader strategies on the other pages of this site.
